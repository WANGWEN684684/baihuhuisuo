...

{
  ...
  "avatar_analysis": "【头像鉴人】请单独对头像进行犀利点评（50字以内）。风格要直接、辛辣、有趣。例如：'用这种卡通头像的人，表面装嫩，内心其实是个控制欲极强的老干部。'",
  ...
  "icebreaker": "【破冰关键】请给出一句最能击中TA灵魂的开场白，或者一个TA绝对无法拒绝的话题。要具体、直接、有效。例如：'既然你也喜欢xx，那一定要去试试xx...'。",
  "suggestions": [
    "建议1（朋友圈布局）：指导用户如何发朋友圈能精准吸引TA的注意（具体的构图、配文风格建议）。",
    "建议2（玄学助攻）：利用星座/生肖相生相克原理，推荐适合的互动时机或幸运话题。",
    "建议3（约会必杀技）：根据TA的社会属性，推荐最能打动TA的约会场所与活动安排。",
    "建议4（情感升温）：如何从普通朋友过渡到暧昧对象的情感升温技巧。"
  ],
  "warnings": [
